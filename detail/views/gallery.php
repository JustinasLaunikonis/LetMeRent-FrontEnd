<?php if ($galleryHasCarousel): ?>
  <div class="<?php echo esc($galleryClass); ?>" data-gallery>
    <div class="gallery-main gallery-main--carousel">
      <button class="gallery-nav gallery-nav--prev" type="button" data-gallery-prev aria-label="Previous photo">&#8249;</button>
      ...
      <button class="gallery-nav gallery-nav--next" type="button" data-gallery-next aria-label="Next photo">&#8250;</button>
      <div class="gallery-count gallery-count--carousel" data-gallery-counter>1 / <?php echo esc((string) count($listingImages)); ?></div>
    </div>
  </div>
<?php else: ?>
